  ...
  <div class="container cardbackground" style="background-color: whitesmoke;">
    ...
    <center>
      <div  style="display: flex; flex-wrap: wrap; row-gap: 3vh;  justify-content:space-between;width: 96%;margin-right: 3vw; margin-left: 5vh;">
        <?php
        $gfn=$_GET["getfoodname"];
        $gfn=str_replace("'","","$gfn");
    $gfn=str_replace('"',"","$gfn");
        $getfoodname="('%$gfn%')";
  $query="SELECT food_id,food_name, food_price, food_description, food_quantity, food_image, cat_id FROM food where food_name like $getfoodname  ORDER BY food_id;";
