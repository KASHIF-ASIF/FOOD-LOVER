...
<html lang="en">
  ...
  <body >
    <div class="container" style="display: flex; justify-content: center;">
      <h2 style="background-color: whitesmoke;">MY ORDER!</h2>
  </div>
  <hr>
...
$query="select order_id,order_des,order_total,user_id,order_time,order_status from order_info where user_id=$uid order by order_id desc;";
