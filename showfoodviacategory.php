...
<html lang="en">
  ...
  <div class="container cardbackground" style="background-color: whitesmoke;">
    <center>
      <h2><b><u style="color: red;">
    <?php
    echo$_GET["catfoodname"];
    ?>
    </u></b></h2>
    </center>
    <hr>
    <center>
      <div  style="display: flex; flex-wrap: wrap; row-gap: 3vh;  justify-content:space-between;width: 96%;margin-right: 3vw; margin-left: 5vh;">
        <?php
        $getcatfoodid=$_GET["catfoodid"];
  $query="SELECT food_id,food_name, food_price, food_description, food_quantity, food_image, cat_id FROM food where cat_id='$getcatfoodid'  ORDER BY food_id;";
